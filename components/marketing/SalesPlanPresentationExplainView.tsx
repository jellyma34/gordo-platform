        ...
        <section className={card}>
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-700/55 bg-slate-950/45 p-3">
              <h3 className="text-[10px] font-bold uppercase tracking-wide text-sky-400/90">Что это</h3>
              <p className="mt-1.5 text-xs leading-relaxed text-slate-300">
                Четыре показателя на одном срезе: накопительное и месячное выполнение плана, отклонение за месяц и накопительное
                отклонение (сделки и выручка). Визуально те же карточки, что в презентации.
              </p>
            </div>
            <div className="rounded-xl border border-slate-700/55 bg-slate-950/45 p-3">
              <h3 className="text-[10px] font-bold uppercase tracking-wide text-sky-400/90">Для чего</h3>
              <p className="mt-1.5 text-xs leading-relaxed text-slate-300">
                Быстро ответить: закрываем ли план по горизонту, тянет ли текущий месяц, где разрыв по штукам и деньгам — без
                углубления в графики ниже.
              </p>
            </div>
            <div className="rounded-xl border border-slate-700/55 bg-slate-950/45 p-3">
              <h3 className="text-[10px] font-bold uppercase tracking-wide text-amber-300/90">Почему важно</h3>
              <p className="mt-1.5 text-xs leading-relaxed text-slate-300">
                Накопительные метрики привязаны к годовому результату; месячные — к оперативным решениям (темп, маркетинг, цена).
                Расхождение штук и выручки сигналит о миксе и среднем чеке.
              </p>
            </div>
            <div className="rounded-xl border border-slate-700/55 bg-slate-950/45 p-3">
              <h3 className="text-[10px] font-bold uppercase tracking-wide text-emerald-400/90">Как влияет</h3>
              <p className="mt-1.5 text-xs leading-relaxed text-slate-300">
                Отставание по накопительному плану увеличивает риск недовыполнения года; сильный минус месяца ускоряет отставание.
                Перевыполнение месяца смягчает прошлый недобор, но не отменяет контроль структуры продаж.
              </p>
            </div>
          </div>
          <div className="mt-5">
