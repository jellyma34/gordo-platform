...
import type { RoomTypeChartRow } from "@/lib/apartmentRoomTypeAnalytics";
...
type Props = {
  rows: readonly RoomTypeChartRow[];
  hasCsvPlan: boolean;
  presDark: boolean;
  presentation: boolean;
};

export function RoomTypePerformanceChart({ rows, hasCsvPlan, presDark, presentation }: Props) {
  const axisColor = presDark ? "#94a3b8" : presentation ? "#64748b" : "#64748b";
